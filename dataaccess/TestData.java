...
public class TestData {
	...
	public void libraryMemberData() {
		...
		record.addCheckoutEntry(new CheckoutRecordEntry(LocalDate.now(), LocalDate.now().plusDays(21), allBooks.get(0).getCopy(2)));
		record.addCheckoutEntry(new CheckoutRecordEntry(LocalDate.of(2022, 3, 21), LocalDate.of(2022, 04, 11), allBooks.get(1).getCopy(1)));
		...
		record.addCheckoutEntry(new CheckoutRecordEntry(LocalDate.of(2022, 4, 1), LocalDate.of(2022, 04, 21), allBooks.get(3).getCopy(1)));
		libraryMember = new LibraryMember("1002", "Drew", "Stevens", "702-998-2414", addresses.get(5), record);
		members.add(libraryMember);

		record = new CheckoutRecord();
		record.addCheckoutEntry(new CheckoutRecordEntry(LocalDate.now(), LocalDate.now().plusDays(21), allBooks.get(2).getCopy(1)));
		libraryMember = new LibraryMember("1003", "Sarah", "Eagleton", "451-234-8811", addresses.get(6), record);
		members.add(libraryMember);

		record = new CheckoutRecord();
		record.addCheckoutEntry(new CheckoutRecordEntry(LocalDate.of(2022, 2, 28), LocalDate.of(2022, 03, 6), allBooks.get(2).getCopy(2)));
